...
import '../main.dart';
import 'models/fill_profile_info_model.dart';
export 'models/fill_profile_info_model.dart';

class FillProfileInfoPage extends StatefulWidget {
  const FillProfileInfoPage({super.key});

  @override
  State<FillProfileInfoPage> createState() => FillProfileInfoPageState();
}

class FillProfileInfoPageState extends State<FillProfileInfoPage> {
  late FillProfileInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FillProfileInfoModel());
    ...
    _model.yourNameTextController12 ??= TextEditingController();
            ...
            children: [
              ...
              Padding(
                ...
                child: TextButton.icon(
                  ...
                  label: Text(
                    dateOfBirth == null ? "Select Date of Birth"
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      if (errorMsg.isEmpty || errorMsg == 'Username already exists!') {
                      ...
                      if (errorMsg.isEmpty) {
                        if (Auth().currentUser?.email != null) {
                          NotificationController.generateWelcomingNotification();
                          DatabaseController.registerUser(Auth().currentUser?.email ?? '',
                          ...
                          chosenImage != null ? DatabaseController.uploadProfileImage(Auth().currentUser!.email ?? '', File(chosenImage!.path)) : null;
