...
import 'models/exercises_search_page_model.dart';
export 'models/exercises_search_page_model.dart';

class ExercisesSearchPage extends StatefulWidget {
  const ExercisesSearchPage({super.key});

  @override
  State<ExercisesSearchPage> createState() => ExercisesSearchPageState();
}

class ExercisesSearchPageState extends State<ExercisesSearchPage> {
  late ExercisesSearchPageModel model;
  ...
  void initState() {
    super.initState();
    model = createModel(context, () => ExercisesSearchPageModel());
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        ...
                        onTap: () {
                          Navigator.of(context).push(MaterialPageRoute(builder: (context) => ExercisePage(exercise: foundResults[index])));
                        },
                      );
                    },
